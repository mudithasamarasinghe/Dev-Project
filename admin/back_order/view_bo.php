<?php 
$qry = $conn->query("SELECT b.*,s.name as supplier,p.po_code FROM back_orders b inner join suppliers s on b.supplier_id = s.id inner join purchase_orders p on b.po_id = p.id  where b.id = '{$_GET['id']}'");
if($qry->num_rows >0){
...
<div class="card card-outline card-primary">
    ...
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php
                    $qry = $conn->query("SELECT b.*,i.name,i.description FROM `bo_items` b inner join items i on b.item_id = i.id where b.bo_id = '{$id}'");
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin/index.php?page=back_order' ?>">Back To List</a>
    </div>
</div>
