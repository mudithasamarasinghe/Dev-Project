...
.headermenu .dropdown-toggle:focus, .headermenu .dropdown-toggle:active, .headermenu .dropdown-toggle.active, .headermenu .open .dropdown-toggle.dropdown-toggle {
    background: #f7f7f7;
    -moz-box-shadow: none;
      ...
      <nav class="main-header navbar navbar-expand navbar-dark border border-light border-top-0  border-left-0 border-right-0 navbar-light text-sm bg-lightblue">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo base_url ?>admin/index.php" class="nav-link"><?php echo (!isMobileDevice()) ? $_settings->info('name'):$_settings->info('short_name'); ?> - Admin</a>
          </li>
        </ul>
	 ...
	 ?>
		<div class="btn-group new_messages">
					...
					while($row = $qry->fetch_assoc()):	?>
							...
							<li class="new" style="white-space: nowrap; ">
							<a href="messagehome.php?id=<?php echo $row['msg_id']; ?>&rle=<?php echo $row['role_name']; ?>&sts=act" class="nav-link nav-home"><?php echo $row['title']; ?></a>
							<a class="message-success" href="messagehome.php?id=<?php echo $row['msg_id']; ?>&rle=<?php echo $row['role_name']; ?>" data-toggle="modal" data-target="#message_modal">
												...
												<?php endwhile; ?>
<li class="new" style="white-space: nowrap; ">												
     <a href="messagehome.php?sts=act" class="nav-link nav-home">
                        <i class="nav-icon ">Read All Active Messages</i>

                      </a></li>
					  <li class="new" style="white-space: nowrap; ">
	
     <a href="messagehome.php?sts=inact" class="nav-link nav-home">
                        <i class="nav-icon ">Read All Inactive Messages</i>
          ...
          <li class="nav-item">
            <div class="btn-group nav-link">
                  ...
                  <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="<?php echo base_url.'admin/index.php?page=user' ?>"><span class="fa fa-user"></span> My Account</a>
