...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Product Details - ".$po_code : 'Enter New Product' ?></h4>
    </div>
    <div class="card-body">
...
//                            }
                        ...
                        <input type="hidden" class="form-control form-control-sm rounded-0" value="<?php echo isset($next_po_code) ? $next_po_code : '' ?>" readonly>
                          <input type="hidden" class="form-control form-control-sm rounded-0" name="supplier_id" id="supplier_id" value="0" readonly>
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        $unit_arr = array();
						 $bom_arr = array();
                        $item = $conn->query("SELECT * FROM `items` where status = 1 and supplier_id=0 order by `name` asc");
                       ?>
					    <div class="col-md-3">
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(resp.status == 'success'){
                        location.replace(_base_url_+"admin/index.php?page=company/view_product&id="+resp.id);
