<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">Material Requestion</h3>
                ...
                <table class="table table-bordered table-stripped">
                    ...
                    while ($row = $qry->fetch_assoc()):
                        ...
                        <tr>
                            ...
                            <td class="text-center has-details create_details" style="cursor: pointer;" data-id="<?php echo $row['id'] ?>">
                                <?php if ($row['status'] == 2): ?>
...
$('.create_details').click(function(){
			uni_modal("Details","purchase_order/detail_po.php?id="+$(this).attr('data-id'),'mid-large')
		})
