    ...
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding-right:11%;"><?php echo $row['quantity'] ?></td>
                    </tr>
            ...
            <div class="row">
                ...
                <?php if($status > 0): ?>
                <div class="col-md-6"><label for="status" class="text-info control-label">Status</label>
                    <p><?php echo ($status == 2)? "Received" : "Partially received" ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
