<?php
$qry = $conn->query("SELECT sl.* FROM sales_list sl where sl.id = '{$_GET['id']}'");
if($qry->num_rows >0){
...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Sales Details - <?php echo $sales_code ?></h4>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="supplier_id" class="control-label text-info">Client</label>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin/index.php?page=sales/manage_sale&id='.(isset($id) ? $id : '') ?>">Edit</a>

        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin/index.php?page=sales' ?>">Back To List</a>
    </div>
</div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Sales Details - Print View")
