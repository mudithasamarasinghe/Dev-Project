	...
	<form action="" id="item-form">
		...
		<div class="form-group">
			...
			<input type="text" name="name" id="name" class="form-control rounded-0" value="<?php echo isset($name) ? $name : ''; ?>">
				...
				<div class="form-group">
			<label for="name" class="control-label">Apparatus</label>
				<div class="form-group">
			<select name="apparatus" id="apparatus" class="custom-select selevt">
			<option value="0" <?php echo isset($apparatus) && $apparatus == 0 ? 'selected' : '' ?>>Component</option>
			<option value="1" <?php echo isset($apparatus) && $apparatus == 0 ? 'selected' : '' ?>>Device</option>
			</select>
		</div>
		</div>
		<div class="form-group">
